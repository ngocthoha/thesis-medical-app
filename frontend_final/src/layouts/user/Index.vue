      ...
      ><v-col cols="12">
        <v-row justify="center"
          ><strong
            ...
            style="color: #322e2a; font-size: 36px"
...
export default {
  ...
  data: () => ({
    image: require("@/assets/img/home/home_content.png"),
    links: [
      {
      ...
      {
        link_name: "Đặt lịch khám theo bác sĩ",
        name: "ĐẶT LỊCH KHÁM THEO BÁC SĨ"
      },
      {
        link_name: "Xem lịch sử cuộc hẹn",
