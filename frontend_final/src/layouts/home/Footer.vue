    ...
    <v-footer id="default-footer" absolute app inset class="ma-0 pa-0">
      ...
      <v-row justify="center" class="blue darken-3 white--text">
        <v-col cols="10">
          <v-row justify="center" class="mt-8 mb-8">
            <v-col cols="3">
              <p class="font-weight-bold display-1">LIÊN HỆ</p>
              <p>Phòng khám tư nhân hỗ trợ đặt lịch khám online</p>
              <p>Trường Đại học BKHCM</p>
            </v-col>
            <v-col cols="3">
              <p class="font-weight-bold display-1">Email: abc@gmail.com</p>
              <p>Trụ sở chính</p>
              <p>Đại học Bách Khoa Tp HCM</p>
            </v-col>
            <v-col cols="6">
              <p class="font-weight-bold display-1">Hotline: 0399 999 999</p>
              <v-row>
                <v-col cols="6">
                  <p>Chi nhánh 2</p>
